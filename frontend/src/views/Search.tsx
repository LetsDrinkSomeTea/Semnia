...
export default function Search({ toast, settings, llmReady }: Props) {
  ...
  useEffect(
    () => setThreshold(settings.search_threshold),
        ...
        <div className="tag-list">
          ...
          {tags.map((t) => (
            <div
              ...
              onClick={() => {
                setTagFilter(tagFilter === t.name ? null : t.name);
                setFilterOpen(false);
              }}
            >
              <span>{t.name}</span>
      ...
      <main className="pb-main">
        <form onSubmit={onSubmit}>
          <div className="search-shell">
            ...
            <input
              ...
              placeholder="Semnia durchsuchen…"
              autoComplete="off"
              spellCheck={false}
            />
            {query && (
        ...
        <div className="meta-line">
          {!isSearchMode ? (
            <>
              <span>
                {browseLoading ? "…" : `${browseEntries.length} Einträge`}
              </span>
              ...
              <div style={{ display: "flex", gap: 8 }}>
                ...
                {isSearchMode && llmReady && (
                  <button
                    ...
                    onClick={() =>
                      navigate(`/agent?q=${encodeURIComponent(query)}`)
                    }
                  >
        ...
        {llmAnswer !== null && (
          <div className="llm-card">
            ...
            <p className="answer">
              {renderWithCitations(llmAnswer, llmSources, (id) =>
                navigate(`/entries/${id}`),
              )}
        ...
        {!isSearchMode ? (
          ...
          <div className="empty">
            ...
            <button
              className="btn"
              onClick={() =>
                navigate(`/editor/new?title=${encodeURIComponent(query)}`)
              }
            >
